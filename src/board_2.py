...
def own_board (size=constants.SIZE,boat1=constants.BOAT1,boat2=constants.BOAT2,boat3=constants.BOAT3,boat4=constants.BOAT4,boat=1):
    '''
...
def enemy_board(size=constants.SIZE,boat1=constants.BOAT1,boat2=constants.BOAT2,boat3=constants.BOAT3,boat4=constants.BOAT4,boat=1):
    '''
...
def blank_board(size=constants.SIZE):
    nboard = size
